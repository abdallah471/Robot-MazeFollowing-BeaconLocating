...
class action_client(object):
    ...
    def __init__(self):
        ...
        rospy.init_node("task4_action_client")

        self.rate = rospy.Rate(1)

        self.goal = SearchGoal()

        self.client = actionlib.SimpleActionClient("/task4_action_server", 
                    SearchAction)
    ...
    def main(self):
        self.send_goal(velocity = 0.20, approach = 0.40)
        prempt = False
        while self.client.get_state() < 10:
            # if self.distance >= 2:
